...
### 2026年3月28日
ブレインビータを実装、詰み判定やリスタートのポップアップやスコア表示などは付けた方がよさそう
箱入り娘を書かせてみたけどクソみたいなコードしか上がってこなかった
とりあえず、自動生成は置いといて、まずは盤面がある状態でプレイ可能なコードを作った方がよさそう
自動生成のルールは、娘を中央下部に設置した状態で、他のマスに縦長コマ横長コマと1マスコマを盤面サイズに応じた数用意してランダムに配置、そこからランダムにシャッフルしていって娘が中央上部に来たらセット完了って流れにしたい
画面遷移はもう、画面ごとにdivで囲って、ハイドを調整するしかないかな

### 2026年4月1日
ブレインビータのUIを整えてたんだけど、アイコン入れたくなって、作ってもらったアイコンを微調整したくてSVG編集ツールを作った
キャンパスの移動とズームがしたくて編集したんだけどなんか色々と壊れたから、とりあえず安定版をindex、調整中のをindex2にした
飯食ってくる
Gravit Designerってやつでいいかも
